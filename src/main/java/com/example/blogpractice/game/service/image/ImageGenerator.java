package com.example.blogpractice.game.service.image;

import com.example.blogpractice.game.dto.PromptSubmissionDto;
...
public class ImageGenerator {
    ...
    public CompletableFuture<String> getImagesFromMessageAsync(String message) {
        ...
        return CompletableFuture.supplyAsync(() -> {
            PromptSubmissionDto prompt = new PromptSubmissionDto(message);
            String response = callImageAI(prompt);
            return parseResponse(response);
        });
    }

    private String callImageAI(PromptSubmissionDto prompt) {
